...
import SwiftUI
    ...
    public class MiraluneEchofieldUpdateManagerSceneController: UIViewController,
        ...
        public func MiraluneEchofieldUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if MiraluneEchofieldUpdateManager.shared.MiraluneEchofieldUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                MiraluneEchofieldUpdateManager.shared.MiraluneEchofieldUpdateManagerFinal = finalUrl
        ...
        public func MiraluneEchofieldUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func MiraluneEchofieldUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func MiraluneEchofieldUpdateManagerToggleNavBar() {
